from EinsumNetworkSGD.Layer import Layer
from EinsumNetworkSGD.ExponentialFamilyArray import *
...
class FactorizedLeafLayer(Layer):
    ...
    def __init__(self, leaves, num_var, num_dims, exponential_family, ef_args):
        """
        ...
        """
        super(FactorizedLeafLayer, self).__init__()
        ...
        self.ef_array = exponential_family(num_var, num_dims, (num_dist, num_replica), **ef_args)
