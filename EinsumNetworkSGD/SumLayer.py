...
class SumLayer(Layer):
	...
	def __init__(self, params_shape, normalization_dims, params_mask=None):
		"""
		...
		# if EM is not used, we reparameterize
...
class EinsumLayer(SumLayer):
	...
	def __init__(self, graph, products, layers, use_em=True):
		...
		super(EinsumLayer, self).__init__(param_shape, normalization_dims=(0, 1))
