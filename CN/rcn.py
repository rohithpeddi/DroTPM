...
"""
    The function for building a skeleton of RCN
...
"""
    The function for learning parameters of RCN
    1) store the marginals from both DATA and MAP intractable module
"""


def rcn_learn_parm(train_dataset, data_name, tum_dir, tum_name, depth, module_dir):
...
"""
    This function is use to combine various option of lambda and beta_function 
    to find the parameter that achieves the best validation set LL score
"""
...
"""
    This function is use to tune the lambda and beta_function to find the 
    best Cutset Network under current structure
"""


def rcn_tune_paramter(train_dataset, valid_dataset, test_dataset, data_name, depth, module_dir):
...
def main_rcn_parm(parms_dict):
	...
	rcn_learn_parm(train_dataset, data_name, tum_dir, tum_name, depth, output_dir)
	rcn_tune_paramter(train_dataset, valid_dataset, test_dataset, data_name, depth, output_dir)
