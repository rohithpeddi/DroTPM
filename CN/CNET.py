...
class CNET:
    ...
    '''
        ...
        1) if all data-points has the same weight, update directly
    ...
    def learn_structure_weight(self, dataset, weights, ids, smooth):
        ...
        return [variable, ids[variable], p0, p1,
                self.learn_structure_weight(new_dataset0, new_weights0, new_ids, smooth),
    ...
    '''
        The recursively part for function getWeights()
    '''
    ...
    '''
        Recursively get the LL score for each datapoint
...
def main_cutset_opt(parms_dict):
    ...
    train_dataset, test_dataset, valid_dataset = datasets.load_debd(data_name)
